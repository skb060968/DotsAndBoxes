/**
 * Optional voice-only chat for Dots & Boxes, powered by LiveKit Cloud.
 *
 * Design guarantees:
 ...
 * Firebase ID token before issuing a LiveKit JWT. The LiveKit room is
 * namespaced per game so it never collides with other games' rooms.
 */
