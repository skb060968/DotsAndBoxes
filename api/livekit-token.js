 ...
 * signature against Google's public keys and check issuer/audience for this
 * app's Firebase project, so only real authenticated users can obtain a token.
 * The LiveKit room is namespaced per game (`<game>-<code>`) so different games
 * sharing one LiveKit project never collide in the same voice room.
 *
